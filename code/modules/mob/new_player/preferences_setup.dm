	...
	proc/update_preview_icon()		//seriously. This is horrendous.
		...
		if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
			...
			switch(job_civilian_high)
				...
				if(LAWYER)
					clothes_s = new /icon('icons/mob/uniform.dmi', "acolyteuniform_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "acolyteboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "acolytegloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "acolytebelt"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "acolytecoat"), ICON_OVERLAY)
				if(CHAPLAIN)
			...
			switch(job_engsec_high)
				...
				if(IMPPSYKER)
					clothes_s = new /icon('icons/mob/uniform.dmi', "imperial_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "spsykerboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "spsykergloves"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/eyes.dmi', "spsykerblindfold"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "spsykercoat"), ICON_OVERLAY)
				if(CHIEF)

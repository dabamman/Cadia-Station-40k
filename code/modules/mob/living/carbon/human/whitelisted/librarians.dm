...
/mob/living/carbon/human/whitelisted/proc/psymode()
...
/mob/living/carbon/human/whitelisted/RangedAttack(var/atom/A)
	if(psymode)
		if(a_intent == "harm")
			lightningbolt(A)
...
/mob/living/carbon/human/whitelisted/proc/lightningbolt(var/atom/T)

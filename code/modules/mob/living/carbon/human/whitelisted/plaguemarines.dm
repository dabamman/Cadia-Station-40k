...
/mob/living/carbon/human/whitelisted/pm/New()
	...
	equip_to_slot_or_del(new /obj/item/weapon/card/id/syndicate, slot_wear_id)
	equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/pmbag/full, slot_r_hand)
	equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/automatic/bpistol/nurglebpistol, slot_belt)

	spawn(20)
		var/weaponchoice = input("Weapons.","Select a weapon.") as null|anything in list("Plague Bolter", "Plague Rifle")
		switch(weaponchoice)
			if("Plague Bolter")
				equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/automatic/bolter/nurglebolter, slot_s_store)
				equip_to_slot_or_del(new /obj/item/weapon/pbayonet, slot_l_hand)
			if("Plague Rifle")
				equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/shotgun/combat/plague, slot_s_store)

				...
				//Rare audio //Now made more common. Yay for insanity! -Drake
					...
					//No more crap sounds. Time to get awesome.
						if(world.time < soundtime + 730 && prob(3)) //Awesome, but a bit too common. Lets keep mixing it up. This rolls for about 1/5 of hallucinations and prob(3) can cut it down a bit.
							var/contents = "[pick("++VOX PRIMARIS++","++VOX PRIMARIS++","++VOX SECONDUS++","++VOX XENOS++","++VOX UNKNOWN++","++VOX HERESYHERESY++")]<br><br>This is [pick("Your Mother","Your Father","Mythra Redd","Norc","Briton","Trevor Kirby")], of the [pick("Admins","rock group Led Zeppelin","Chaos Gods","Federal Reserve Bank","Ork Waaagh","Frito Lay Corperation","KOALA COALITION FOR WORLD DOMINATION","Necrontyr Empire","Tyranid Hive Fleet Chicken","Tyranid's Rights Initiative","The Greater Good")].<br>It has come to [pick("our","my")] attention that [pick("you are in a video game!","you are on drugs!")]" //Mixing it up.
							var/message = ""
	...
	if(prob(80)) //Make the percieved attacker more interesting. -Drake
		switch(rand(1,34))
			...
			if(12)
				...
				F.name = pick("Enraged Parrot","Daemon","Salamander Marine")
			...
			if(15)
				...
				F.weapon_name = pick("fireball","shit","heresy", "fell magiks")
			if(16)
